          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-secondary-600 text-white py-3 rounded-lg font-semibold hover:bg-secondary-700 transition shadow-lg"
                >
                  Send Message
                </button>
              </form>
            </div>
            <div className="space-y-8 bg-white/95 backdrop-blur-sm rounded-2xl p-10 shadow-2xl">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-gray-800">Get in Touch</h3>
                <div className="space-y-6">
                  <div className="flex items-start group">
                    <div className="bg-gradient-to-br from-secondary-100 to-secondary-200 rounded-xl p-4 mr-4 shadow-md group-hover:shadow-lg transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Political Avenue, Abuja, Nigeria</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@electhernigeria.org</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-secondary-100 rounded-full p-3 mr-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-4 text-xl">Follow Us</h4>
                <div className="flex space-x-4">
                  <a href="#" className="bg-gradient-to-br from-secondary-600 to-secondary-700 text-white rounded-xl p-4 hover:from-secondary-700 hover:to-secondary-800 transition-all shadow-lg hover:shadow-xl transform hover:scale-110">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="#" className="bg-primary-500 text-white rounded-full p-3 hover:bg-primary-600 transition">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
